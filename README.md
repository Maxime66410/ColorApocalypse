...
**ColorApocalypse** is a Minecraft (Forge) mod that turns survival into a chaotic and unpredictable challenge: the world progressively loses its colors, and each color that disappears causes the instant destruction of everything associated with it blocks, mobs, and item drops.
